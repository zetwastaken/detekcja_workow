...
# test_image = 'path/to/tiling/all_V1_640_80'  # CHANGE THIS

# test_image = 'path/to/dobre_do_wykorzystania/DJI_0398_2pD.JPG'  # Whole image
...
for i, result in enumerate(results):
    ...
    if result.masks is not None:
        ...
        for j, (box, mask, conf, cls) in enumerate(
            zip(
                result.boxes.xyxy,
                result.masks.data,
                result.boxes.conf,
